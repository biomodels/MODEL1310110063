# MODEL1310110063: MODEL1310110063
...
`pip install git+https://github.com/biomodels/MODEL1310110063.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110063.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110063 as model`
...
The model of bronchus respiratory epithelial cells metabolism is derived from
...
and identified by:
[MODEL1310110063](http://identifiers.org/biomodels.db/MODEL1310110063) .
